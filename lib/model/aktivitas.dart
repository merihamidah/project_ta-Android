...
List<Aktivitas> aktivitasList = [
  Aktivitas(
      ...
      description:
          'Morning sickness adalah Aktivitas mual dan muntah yang dialami oleh banyak ibu hamil. Tanda kehamilan normal ini biasanya muncul pada usia kehamilan 4–12 minggu. Meski disebut morning sickness, Aktivitas ini juga bisa dirasakan pada siang atau malam hari. Untuk meredakan mual saat hamil, Bumil bisa mengonsumsi makanan dengan porsi sedikit namun lebih sering atau mencoba minum teh jahe. Karena morning sickness bisa membuat Bumil lebih sensitif terhadap aroma makanan, hindarilah konsumsi makanan yang pedas, berlemak, atau berbau tajam.Bila mual dan muntah yang dialami cukup parah atau berlangsung sepanjang hari hingga membuat Bumil tidak bisa mengonsumsi makanan apa pun, segeralah konsultasikan ke dokter kandungan. Kondisi tersebut bisa jadi disebabkan oleh hipermemesis gravidarum yang perlu segera ditangani oleh dokter.'),
  Aktivitas(
      title: 'Pendarahan ',
      imageUrl:
